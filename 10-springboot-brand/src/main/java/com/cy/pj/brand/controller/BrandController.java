...
public class BrandController {
    ...
    public String doDeleteById(@PathVariable Integer id,Model model) throws InterruptedException {
    ...
    public String doFindBrands(@PathVariable(required = false)  String name, Model model) throws InterruptedException {
